...
Settings.llm = GoogleGenAI(
    model="models/gemini-3.6-flash",  # gemini-2.5-flash is closed to new accounts
    api_key=google_api_key
)

# Using Google's modern text-embedding model
Settings.embed_model = GoogleGenAIEmbedding(
    model_name="models/gemini-embedding-001",  # text-embedding-004 was retired by Google
    api_key=google_api_key
)
